      ...
      callback({
        responseHeaders: {
          ...
          "Content-Security-Policy": [
            "default-src 'self'; script-src 'self' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self' http://localhost:3001 http://192.168.1.18:3001 http://* https://*;",
          ],
        },
      });
    }

export const KYORUGI_CATEGORIES = {
  MALE: {
    ...
    BENJAMIN: [
      { name: "-21kg", pss: "# 0", hitLevel: 7 },
      { name: "-24kg", pss: "# 0", hitLevel: 7 },
      { name: "-27kg", pss: "# 0", hitLevel: 8 },
      { name: "-30kg", pss: "# 0", hitLevel: 8 },
      { name: "-33kg", pss: "# 0", hitLevel: 9 },
      { name: "-37kg", pss: "# 0", hitLevel: 9 },
      { name: "-41kg", pss: "# 1", hitLevel: 9 },
      { name: "-45kg", pss: "# 1", hitLevel: 10 },
      { name: "-49kg", pss: "# 1", hitLevel: 11 },
      { name: "+49kg", pss: "# 2", hitLevel: 13 },
    ],
    MINIME: [
  ...
  FEMALE: {
    ...
    BENJAMIN: [
      ...
      { name: "-37kg", pss: "# 1", hitLevel: 9 },
      { name: "-41kg", pss: "# 1", hitLevel: 10 },
      { name: "-44kg", pss: "# 1", hitLevel: 11 },
      { name: "+44kg", pss: "# 2", hitLevel: 12 },
    ],
    MINIME: [
      { name: "-23kg", pss: "# 0", hitLevel: 7 },

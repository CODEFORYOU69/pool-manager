// Mapping positions A/B → Rouge/Bleu pour l'affichage UI
...
export const POWER_THRESHOLDS = {
  ...
  cadets: {
    male: [
      { min: 0, max: -33, threshold: "-33 Kg", pss: "# 0", hitLevel: 10 },
      { min: -33, max: -37, threshold: "-37 Kg", pss: "# 0", hitLevel: 11 },
      { min: -37, max: -41, threshold: "-41 Kg", pss: "# 1", hitLevel: 13 },
      { min: -41, max: -45, threshold: "-45 Kg", pss: "# 1", hitLevel: 14 },
      { min: -45, max: -49, threshold: "-49 Kg", pss: "# 1", hitLevel: 15 },
      { min: -49, max: -53, threshold: "-53 Kg", pss: "# 2", hitLevel: 16 },
      { min: -53, max: -57, threshold: "-57 Kg", pss: "# 2", hitLevel: 17 },
      { min: -57, max: -61, threshold: "-61 Kg", pss: "# 2", hitLevel: 18 },
      { min: -61, max: -65, threshold: "-65 Kg", pss: "# 3", hitLevel: 19 },
      { min: 65, max: 1000, threshold: "+65 Kg", pss: "# 3", hitLevel: 20 },
    ],
    female: [
      { min: 0, max: -29, threshold: "-29 Kg", pss: "# 0", hitLevel: 10 },
      { min: -29, max: -33, threshold: "-33 Kg", pss: "# 0", hitLevel: 11 },
      { min: -33, max: -37, threshold: "-37 Kg", pss: "# 1", hitLevel: 13 },
      { min: -37, max: -41, threshold: "-41 Kg", pss: "# 1", hitLevel: 14 },
      { min: -41, max: -45, threshold: "-45 Kg", pss: "# 1", hitLevel: 15 },
      { min: -45, max: -49, threshold: "-49 Kg", pss: "# 1", hitLevel: 16 },
      { min: -49, max: -53, threshold: "-53 Kg", pss: "# 2", hitLevel: 17 },
      { min: -53, max: -57, threshold: "-57 Kg", pss: "# 2", hitLevel: 18 },
      { min: -57, max: 1000, threshold: "+57 Kg", pss: "# 3", hitLevel: 19 },
    ],
  },
  // JUNIORS
  juniors: {
    male: [
      { min: 0, max: -45, threshold: "-45 Kg", pss: "# 1", hitLevel: 17 },
      { min: -45, max: -48, threshold: "-48 Kg", pss: "# 2", hitLevel: 18 },
      { min: -48, max: -51, threshold: "-51 Kg", pss: "# 2", hitLevel: 19 },
      { min: -51, max: -55, threshold: "-55 Kg", pss: "# 2", hitLevel: 20 },
      { min: -55, max: -59, threshold: "-59 Kg", pss: "# 3", hitLevel: 21 },
      { min: -59, max: -63, threshold: "-63 Kg", pss: "# 3", hitLevel: 22 },
      { min: -63, max: -67, threshold: "-67 Kg", pss: "# 3", hitLevel: 23 },
      { min: -67, max: -73, threshold: "-73 Kg", pss: "# 4", hitLevel: 24 },
      { min: -73, max: -78, threshold: "-78 Kg", pss: "# 4", hitLevel: 25 },
      { min: 78, max: 1000, threshold: "+78 Kg", pss: "# 4", hitLevel: 26 },
    ],
    female: [
      { min: 0, max: -42, threshold: "-42 Kg", pss: "# 1", hitLevel: 14 },
      { min: -42, max: -44, threshold: "-44 Kg", pss: "# 1", hitLevel: 15 },
      { min: -44, max: -46, threshold: "-46 Kg", pss: "# 1", hitLevel: 16 },
      { min: -46, max: -49, threshold: "-49 Kg", pss: "# 2", hitLevel: 17 },
      { min: -49, max: -52, threshold: "-52 Kg", pss: "# 2", hitLevel: 18 },
      { min: -52, max: -55, threshold: "-55 Kg", pss: "# 2", hitLevel: 19 },
      { min: -55, max: -59, threshold: "-59 Kg", pss: "# 3", hitLevel: 20 },
      { min: -59, max: -63, threshold: "-63 Kg", pss: "# 3", hitLevel: 21 },
      { min: -63, max: -67, threshold: "-67 Kg", pss: "# 3", hitLevel: 22 },
      { min: 67, max: 1000, threshold: "+67 Kg", pss: "# 4", hitLevel: 23 },
    ],
  },
  // SENIORS
  seniors: {
    male: [
      { min: 0, max: -54, threshold: "-54 Kg", pss: "# 2", hitLevel: 21 },
      { min: -54, max: -58, threshold: "-58 Kg", pss: "# 2", hitLevel: 22 },
      { min: -58, max: -63, threshold: "-63 Kg", pss: "# 3", hitLevel: 23 },
      { min: -63, max: -68, threshold: "-68 Kg", pss: "# 3", hitLevel: 24 },
      { min: -68, max: -74, threshold: "-74 Kg", pss: "# 3", hitLevel: 25 },
      { min: -74, max: -80, threshold: "-80 Kg", pss: "# 4", hitLevel: 26 },
      { min: -80, max: -87, threshold: "-87 Kg", pss: "# 4", hitLevel: 27 },
      { min: 87, max: 1000, threshold: "+87 Kg", pss: "# 4/5", hitLevel: 28 },
    ],
    female: [
      { min: 0, max: -46, threshold: "-46 Kg", pss: "# 2", hitLevel: 17 },
      { min: -46, max: -49, threshold: "-49 Kg", pss: "# 2", hitLevel: 18 },
      { min: -49, max: -53, threshold: "-53 Kg", pss: "# 2", hitLevel: 19 },
      { min: -53, max: -57, threshold: "-57 Kg", pss: "# 2", hitLevel: 20 },
      { min: -57, max: -62, threshold: "-62 Kg", pss: "# 3", hitLevel: 21 },
      { min: -62, max: -67, threshold: "-67 Kg", pss: "# 3", hitLevel: 22 },
      { min: -67, max: -73, threshold: "-73 Kg", pss: "# 4", hitLevel: 23 },
  ...
  espoirs: {
    male: [
      { min: 0, max: -54, threshold: "-54 Kg", pss: "# 2", hitLevel: 20 },
      { min: -54, max: -58, threshold: "-58 Kg", pss: "# 2", hitLevel: 21 },
      { min: -58, max: -63, threshold: "-63 Kg", pss: "# 3", hitLevel: 22 },
      { min: -63, max: -68, threshold: "-68 Kg", pss: "# 3", hitLevel: 23 },
      { min: -68, max: -74, threshold: "-74 Kg", pss: "# 3", hitLevel: 24 },
      { min: -74, max: -80, threshold: "-80 Kg", pss: "# 4", hitLevel: 25 },
      { min: -80, max: -87, threshold: "-87 Kg", pss: "# 4", hitLevel: 26 },
      { min: 87, max: 1000, threshold: "+87 Kg", pss: "# 4/5", hitLevel: 27 },
    ],
    female: [
      { min: 0, max: -46, threshold: "-46 Kg", pss: "# 2", hitLevel: 16 },
      { min: -46, max: -49, threshold: "-49 Kg", pss: "# 2", hitLevel: 17 },
      { min: -49, max: -53, threshold: "-53 Kg", pss: "# 2", hitLevel: 18 },
      { min: -53, max: -57, threshold: "-57 Kg", pss: "# 3", hitLevel: 19 },
      { min: -57, max: -62, threshold: "-62 Kg", pss: "# 3", hitLevel: 20 },
      { min: -62, max: -67, threshold: "-67 Kg", pss: "# 4", hitLevel: 21 },
      { min: -67, max: -73, threshold: "-73 Kg", pss: "# 4", hitLevel: 22 },
  ...
  master: {
    male: [
      { min: 0, max: -58, threshold: "-58 Kg", pss: "# 2", hitLevel: 19 },
      { min: -58, max: -68, threshold: "-68 Kg", pss: "# 3", hitLevel: 20 },
      { min: -68, max: -80, threshold: "-80 Kg", pss: "# 4", hitLevel: 21 },
      { min: 80, max: 1000, threshold: "+80 Kg", pss: "# 4", hitLevel: 22 },
    ],
    female: [
      { min: 0, max: -49, threshold: "-49 Kg", pss: "# 2", hitLevel: 17 },
      { min: -49, max: -57, threshold: "-57 Kg", pss: "# 2", hitLevel: 18 },
      { min: -57, max: -67, threshold: "-67 Kg", pss: "# 3", hitLevel: 19 },
  ...
  olympic: {
    male: [
      { min: 0, max: -58, threshold: "-58 Kg", pss: "# 3", hitLevel: 22 },
      { min: -58, max: -68, threshold: "-68 Kg", pss: "# 3", hitLevel: 24 },
      { min: -68, max: -80, threshold: "-80 Kg", pss: "# 4", hitLevel: 26 },
      { min: 80, max: 1000, threshold: "+80 Kg", pss: "# 5", hitLevel: 28 },
    ],
    female: [
      { min: 0, max: -49, threshold: "-49 Kg", pss: "# 2", hitLevel: 18 },
      { min: -49, max: -57, threshold: "-57 Kg", pss: "# 2", hitLevel: 19 },
      { min: -57, max: -67, threshold: "-67 Kg", pss: "# 3", hitLevel: 20 },
